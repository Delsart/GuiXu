...
import work.delsart.guixu.platform.FixSizeFileAccess
...
abstract class BasicBox(val host: GuiXu, val path: Path, val name: String) {
    // for management, set null to use _::class.qualifiedName
    open val boxType: String? = null
    ...
    private fun mergeFile(
        ...
        val emptyIndexItemArray = ByteArray(indexItemLength)
