...
class FixSizeFileAccess(override val path: Path, val size: Long = 0, mode: String = "rw") : FileAccess {
...
private const val maxIncreaseSize = (1L shl 21) // 2M
...
open class AutoIncreaseFileAccess(override val path: Path, minimumSize: Long = 0, mode: String = "rw") : FileAccess {
    ...
    private var actualLength = if (fileLength >= 8) {
